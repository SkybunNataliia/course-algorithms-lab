...
unsigned int hash_str(TKey key) {
    unsigned int h = 0;
...
int main(void) {
    ...
    hashtable_insert(h, "one", 77);
    hashtable_insert(h, "two", 66);
    hashtable_insert(h, "three", 99);
    hashtable_insert(h, "four", 55);
    ...
    hashtable_delete(h, "three");
    hashtable_print(h, 0, "after removal of key 'three' =");
    hashtable_delete_value(h, "four", 55);
...
void test_merge() {
    ...
    hashtable_insert(h1, "one", 100);
    hashtable_insert(h1, "two", 200);

    HashTable *h2 = hashtable_create(5);
    hashtable_insert(h2, "three", 300);
    hashtable_insert(h2, "four", 400);
    hashtable_insert(h2, "two", 250);
